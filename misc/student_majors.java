// ORM class for table 'student_majors'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Thu Jun 15 15:15:52 PDT 2017
...
public class student_majors extends SqoopRecord  implements DBWritable, Writable {
  private final int PROTOCOL_VERSION = 3;
  public int getClassFormatVersion() { return PROTOCOL_VERSION; }
  protected ResultSet __cur_result_set;
  private Integer student_major_id;
  public Integer get_student_major_id() {
    return student_major_id;
  }
  public void set_student_major_id(Integer student_major_id) {
    this.student_major_id = student_major_id;
  }
  public student_majors with_student_major_id(Integer student_major_id) {
    this.student_major_id = student_major_id;
    return this;
  }
  ...
  public student_majors with_student_id(Integer student_id) {
    this.student_id = student_id;
    return this;
  }
  ...
  public student_majors with_major_id(Integer major_id) {
    this.major_id = major_id;
    return this;
  }
  ...
  public student_majors with_evnt_tmestmp(java.sql.Timestamp evnt_tmestmp) {
    this.evnt_tmestmp = evnt_tmestmp;
    return this;
  }
  ...
  public student_majors with_evnt_oper_id(String evnt_oper_id) {
    this.evnt_oper_id = evnt_oper_id;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof student_majors)) {
      return false;
    }
    student_majors that = (student_majors) o;
    boolean equal = true;
    equal = equal && (this.student_major_id == null ? that.student_major_id == null : this.student_major_id.equals(that.student_major_id));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.student_major_id = JdbcWritableBridge.readInteger(1, __dbResults);
    this.student_id = JdbcWritableBridge.readInteger(2, __dbResults);
    this.major_id = JdbcWritableBridge.readInteger(3, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    JdbcWritableBridge.writeInteger(student_major_id, 1 + __off, 4, __dbStmt);
    JdbcWritableBridge.writeInteger(student_id, 2 + __off, 4, __dbStmt);
    JdbcWritableBridge.writeInteger(major_id, 3 + __off, 4, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    if (__dataIn.readBoolean()) { 
        this.student_major_id = null;
    } else {
    this.student_major_id = Integer.valueOf(__dataIn.readInt());
    }
    if (__dataIn.readBoolean()) { 
  ...
  public void write(DataOutput __dataOut) throws IOException {
    if (null == this.student_major_id) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    __dataOut.writeInt(this.student_major_id);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(FieldFormatter.escapeAndEnclose(student_major_id==null?"null":"" + student_major_id, delimiters));
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    try {
    __cur_str = __it.next();
    if (__cur_str.equals("null") || __cur_str.length() == 0) { this.student_major_id = null; } else {
      this.student_major_id = Integer.valueOf(__cur_str);
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    student_majors o = (student_majors) super.clone();
    o.evnt_tmestmp = (o.evnt_tmestmp != null) ? (java.sql.Timestamp) o.evnt_tmestmp.clone() : null;
    return o;
  }

  public void clone0(student_majors o) throws CloneNotSupportedException {
    o.evnt_tmestmp = (o.evnt_tmestmp != null) ? (java.sql.Timestamp) o.evnt_tmestmp.clone() : null;
  }

  public Map<String, Object> getFieldMap() {
    Map<String, Object> __sqoop$field_map = new TreeMap<String, Object>();
    __sqoop$field_map.put("student_major_id", this.student_major_id);
  ...
  public void setField(String __fieldName, Object __fieldVal) {
    if ("student_major_id".equals(__fieldName)) {
      this.student_major_id = (Integer) __fieldVal;
    }
    else    if ("student_id".equals(__fieldName)) {
      this.student_id = (Integer) __fieldVal;
    }
    else    if ("major_id".equals(__fieldName)) {
