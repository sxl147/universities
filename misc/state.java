// ORM class for table 'state'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Thu Jun 15 14:43:38 PDT 2017
...
public class state extends SqoopRecord  implements DBWritable, Writable {
  ...
  public state with_state_id(Integer state_id) {
    this.state_id = state_id;
    return this;
  }
  ...
  public state with_country_id(Integer country_id) {
    this.country_id = country_id;
    return this;
  }
  ...
  public state with_state_code(String state_code) {
    this.state_code = state_code;
    return this;
  }
  ...
  public state with_state_name(String state_name) {
    this.state_name = state_name;
    return this;
  }
  ...
  public state with_evnt_tmestmp(java.sql.Timestamp evnt_tmestmp) {
    this.evnt_tmestmp = evnt_tmestmp;
    return this;
  }
  ...
  public state with_evnt_oper_id(String evnt_oper_id) {
    this.evnt_oper_id = evnt_oper_id;
    return this;
  }
  public boolean equals(Object o) {
    ...
    equal = equal && (this.state_name == null ? that.state_name == null : this.state_name.equals(that.state_name));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.state_id = JdbcWritableBridge.readInteger(1, __dbResults);
    this.country_id = JdbcWritableBridge.readInteger(2, __dbResults);
    this.state_code = JdbcWritableBridge.readString(3, __dbResults);
    this.state_name = JdbcWritableBridge.readString(4, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    JdbcWritableBridge.writeInteger(state_id, 1 + __off, 4, __dbStmt);
    JdbcWritableBridge.writeInteger(country_id, 2 + __off, 4, __dbStmt);
    JdbcWritableBridge.writeString(state_code, 3 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(state_name, 4 + __off, 12, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    this.state_name = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.state_name) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, state_name);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(state_name==null?"null":state_name, delimiters));
    __sb.append(fieldDelim);
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    __cur_str = __it.next();
    if (__cur_str.equals("null")) { this.state_name = null; } else {
      this.state_name = __cur_str;
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    state o = (state) super.clone();
    o.evnt_tmestmp = (o.evnt_tmestmp != null) ? (java.sql.Timestamp) o.evnt_tmestmp.clone() : null;
    return o;
  }

  public void clone0(state o) throws CloneNotSupportedException {
    o.evnt_tmestmp = (o.evnt_tmestmp != null) ? (java.sql.Timestamp) o.evnt_tmestmp.clone() : null;
  }
  ...
  public Map<String, Object> getFieldMap() {
    ...
    __sqoop$field_map.put("state_name", this.state_name);
  ...
  public void setField(String __fieldName, Object __fieldVal) {
    if ("state_id".equals(__fieldName)) {
      this.state_id = (Integer) __fieldVal;
    }
    else    if ("country_id".equals(__fieldName)) {
      this.country_id = (Integer) __fieldVal;
    }
    else    if ("state_code".equals(__fieldName)) {
      this.state_code = (String) __fieldVal;
    }
    else    if ("state_name".equals(__fieldName)) {
      this.state_name = (String) __fieldVal;
    }
